...
export const profiles = PropTypes.arrayOf(
    profile
).isRequired;

export const bulletPoints = PropTypes.arrayOf(
    PropTypes.string
).isRequired;
...
export const workSet = PropTypes.arrayOf(
    work
).isRequired;
...
export const volunteerSet = PropTypes.arrayOf(
    volunteer
).isRequired;
...
export const educationSet = PropTypes.arrayOf(
    education
).isRequired;
...
export const awardsSet = PropTypes.arrayOf(
    awards
).isRequired;
...
export const projectsSet = PropTypes.arrayOf(
    projects
).isRequired;
...
export const skillDetailsSet = PropTypes.arrayOf(
    skillDetails
);
...
export const languagesSet = PropTypes.arrayOf(
    languages
).isRequired;
...
export const interestsSet = PropTypes.arrayOf(
    interests
).isRequired;
...
export const referencesSet = PropTypes.arrayOf(
    references
).isRequired;
